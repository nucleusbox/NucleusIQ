...
class TestTaskCreation:
    ...
    def test_task_creation_with_context_only(self):
        ...
        task = Task(id="task1", objective="Test task", context={"key": "value"})
    ...
    def test_task_creation_with_metadata_only(self):
        ...
        task = Task(id="task1", objective="Test task", metadata={"key": "value"})
...
class TestTaskSerialization:
    ...
    def test_task_from_dict_minimal(self):
        ...
        task_dict = {"id": "task1", "objective": "Minimal task"}
    ...
    def test_task_from_dict_with_id_string(self):
        ...
        task_dict = {"id": task_id_str, "objective": "Test task"}
