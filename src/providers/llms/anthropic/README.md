...
| **This line** | **`0.2.2`** — **Development Status :: 5 - Production/Stable** (first stable line is `0.2.0`; `0.2.1` declared `PROVIDER_NAME`; `0.2.2` closes nested objects with `additionalProperties: false` so Claude structured output accepts nested Pydantic models). |
