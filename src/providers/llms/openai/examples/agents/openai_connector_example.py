...
async def main():
    ...
    logger.info("   Connector ID: connector_googlecalendar")
    logger.info("   Server Label: google_calendar")
    ...
    prompt = ZeroShotPrompt().configure(
        system="Has access to Google Calendar via OpenAI connector.",
    ...
    if oauth_token and oauth_token != "ya29.PLACEHOLDER_TOKEN":
        ...
        task = {"id": "task1", "objective": "What's on my Google Calendar for today?"}
