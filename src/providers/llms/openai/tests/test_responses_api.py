...
class TestPerToolRouting:
    ...
    async def test_web_search_routes_to_responses_api(self):
        ...
        fake_resp = _FakeResponse("resp_ws", [
    ...
    async def test_code_interpreter_routes_to_responses_api(self):
        ...
        fake_resp = _FakeResponse("resp_ci", [
        ...
        assert any(n["type"] == "code_interpreter_call" for n in msg.get("_native_outputs", []))

    @pytest.mark.asyncio
    async def test_file_search_routes_to_responses_api(self):
        """file_search triggers Responses API."""
        fake_resp = _FakeResponse("resp_fs", [
            _FakeOutputItem("file_search_call", id="fs_1", status="completed"),
            _FakeOutputItem("message", role="assistant",
                            content=[_FakeContentBlock("output_text", "Found in document: answer is X.")]),
        ])
        self.llm._client.responses = _FakeResponses(fake_resp)
    ...
    async def test_image_generation_routes_to_responses_api(self):
        ...
        fake_resp = _FakeResponse("resp_ig", [
            _FakeOutputItem("image_generation_call", id="ig_1", status="completed"),
            _FakeOutputItem("message", role="assistant",
                            content=[_FakeContentBlock("output_text", "Here is the generated image.")]),
        ])
        self.llm._client.responses = _FakeResponses(fake_resp)
    ...
    async def test_mcp_routes_to_responses_api(self):
        ...
        fake_resp = _FakeResponse("resp_mcp", [
            _FakeOutputItem("message", role="assistant",
    ...
    async def test_computer_use_routes_to_responses_api(self):
        ...
        fake_resp = _FakeResponse("resp_cu", [
    ...
    async def test_function_only_routes_to_chat_completions(self):
        ...
        self.llm._client.chat.completions.create = AsyncMock(return_value=fake_chat_resp)
...
class TestMixedToolRouting:
    ...
    async def test_mixed_tools_route_to_responses_api(self):
        ...
        fake_resp = _FakeResponse("resp_mix", [
            _FakeOutputItem("web_search_call", id="ws_1", status="completed"),
            _FakeOutputItem("message", role="assistant",
                            content=[_FakeContentBlock("output_text", "Answer with search and calc.")]),
        ])
        self.llm._client.responses = _FakeResponses(fake_resp)
    ...
    async def test_mixed_tools_with_function_call_response(self):
        ...
        fake_resp = _FakeResponse("resp_mix_fn", [
            _FakeOutputItem("web_search_call", id="ws_1", status="completed"),
            _FakeOutputItem("function_call",
                            call_id="call_add_1",
                            name="add",
                            arguments='{"a": 10, "b": 20}'),
        ])
...
class TestConversationContinuity:
    ...
    async def test_function_call_sets_response_id(self):
        ...
        fake_resp = _FakeResponse("resp_turn1", [
            _FakeOutputItem("function_call",
                            call_id="call_1",
                            name="add",
                            arguments='{"a": 5, "b": 3}'),
    ...
    async def test_final_answer_resets_response_id(self):
        ...
        fake_resp = _FakeResponse("resp_final", [
            _FakeOutputItem("message", role="assistant",
...
class TestStructuredOutputViaResponsesAPI:
    ...
    async def test_json_schema_structured_output(self):
        ...
        fake_resp = _FakeResponse("resp_so", [
            _FakeOutputItem("message", role="assistant",
                            content=[_FakeContentBlock("output_text", '{"name": "Alice", "age": 30}')]),
        ])
...
class TestNormalizationEdgeCases:
    ...
    def test_multiple_function_calls(self):
        ...
        resp = _FakeResponse("resp_multi_fn", [
            _FakeOutputItem("function_call", call_id="c1", name="add", arguments='{"a":1,"b":2}'),
            _FakeOutputItem("function_call", call_id="c2", name="multiply", arguments='{"a":3,"b":4}'),
        ])
    ...
    def test_only_native_outputs_no_text(self):
        ...
        resp = _FakeResponse("resp_native_only", [
            _FakeOutputItem("web_search_call", id="ws_1", status="completed"),
        ])
...
class TestResponsesCallDirect:
    ...
    async def test_responses_call_returns_raw_response(self):
        ...
        llm = _make_llm()
        fake_resp = _FakeResponse("resp_raw", [
            _FakeOutputItem("message", role="assistant",
