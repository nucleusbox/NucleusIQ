"""JSON schema cleanup for Ollama ``format`` structured outputs."""
...
def clean_schema_for_ollama(schema: dict[str, Any]) -> dict[str, Any]:
    """Clean a Pydantic JSON schema for Ollama ``chat(.., format=...)``."""
